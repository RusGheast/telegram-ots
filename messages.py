...
RU_TEXTS = {
    "start_message": (
        "Добро пожаловать в RightGift— ваш надежный P2P-гарант в Telegram!\n\n"
        "💼 Покупайте и продавайте что угодно — легко и безопасно. От Telegram-подарков и NFT до криптовалют и фиата — сделки проходят быстро, прозрачно и без риска.\n"
        "От Telegram-подарков и NFT до токенов и фиата – сделки проходят легко и без риска.\n\n"
        "🔐 Поддержка современных кошельков\n"
        "🔰Небольшая комиссия - всего 2% со сделки\n\n"
        "🛡️ Гарантированная безопасность каждой сделки?\n"
    ...
    "payment_confirmed_seller_message": (
        "✅ Оплата подтверждена для сделки #{deal_id}\n\n"
        "Описание: {description}\n\n"
        "Отправьте подарок покупателю — @SupGIFTBot\n\n"
...
EN_TEXTS = {
    "start_message": (
        "Welcome to RightGift — your reliable P2P guarantor on Telegram!nn"
        " 💼 Buy and sell anything – easily and safely. From Telegram gifts and NFTs to cryptocurrencies and fiat, transactions are fast, transparent, and risk-free.n"
        "From Telegram gifts and NFTs to tokens and fiat, transactions are easy and risk-free.nn"
        "🔐 Support for modern wallets"
        "🔰Small commission - only 2% of the transactionnn"
        "🛡️ Guaranteed security of every transaction?n"
